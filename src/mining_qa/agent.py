...
class MiningQAAgent:
    ...
    async def generate_evidence(self, request: AskRequest) -> EvidenceBundleResponse:
        """Run the same governed retrieval pipeline without answer synthesis."""
    ...
    async def _execute_evidence_pipeline(
        ...
        *,
        ...
        if not domain_decision.in_scope:
            ...
            output = self._evidence_bundle_from_response(
                response,
                original_question=request.question,
                retrieval_question=question,
            ) if evidence_only else response
        ...
        if not has_usable_evidence:
            ...
            missing_evidence = list(dict.fromkeys(
                [
                    ...
                    *(rerank_result.missing_evidence_groups if rerank_result else ()),
                ]
